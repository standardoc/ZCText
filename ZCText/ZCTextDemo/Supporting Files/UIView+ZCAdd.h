 ...
 */
@interface UIView (ZCAdd)

/**
 *  ShortCut to see the view.layer's shadow
 *
 *  @param color  Shadow Color
 *  @param offset Shadow offset
 *  @param radius Shadow radius
 */
- (void)setLayoutShadow:(UIColor *)color offset:(CGSize)offset radius:(CGFloat)radius;
...
double ZCDeviceSystemVersion();

#ifndef kSystemVersion
#define kSystemVersion ZCDeviceSystemVersion()
#endif
...
CGSize ZCDeviceScreenSize();

/// 屏幕宽度
#ifndef kScreenWidth
#define kScreenWidth ZCDeviceScreenSize().width
#endif

/// 屏幕高度
#ifndef kScreenHeight
#define kScreenHeight ZCDeviceScreenSize().height
#endif

/// 屏幕大小
#ifndef kScreenSize
#define kScreenSize ZCDeviceScreenSize()
#endif
